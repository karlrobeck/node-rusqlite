...
impl Savepoint<'_> {
  ...
  #[inline]
  pub fn savepoint_with_name<T: Into<String>>(&self, name: T) -> Result<Savepoint<'_>> {
    Savepoint::with_name_(self.conn, name)
  }
...
impl Connection {
  ...
  #[cfg(feature = "modern_sqlite")] // 3.37.0
  pub fn transaction_state<N: crate::Name>(&self, db_name: Option<N>) -> Result<TransactionState> {
